...
//Deliverable 3: Create a thid tile layer 
...
// Add a 2nd and 3rdlayer group for the tectonic plate data.
...
let overlays = {
  ...
  "Major Earthquakes(M4.5+)": majorEarthquakes
};
...
// Deliverable 1: Use d3.json to make a call to get our Tectonic Plate geoJSON data.
...
// Deliverable 2: Retrieve the major earthquake GeoJSON data >4.5 mag for the week.
var majEQ = "https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/4.5_week.geojson";
d3.json(majEQ).then(function(data) {
